        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-4">
                    <ul class="flex items-center space-x-4 lg:hidden">
                        <li>
                            <button class="text-gray-500 hover:text-gray-700 p-2 rounded-md" id="menu-toggle">
                    ...
                    <ul class="hidden lg:flex items-center space-x-4">
                        <li>
                            <a href="/booking/add" class="text-gray-500 hover:text-gray-700 p-2 rounded-md" title="Add Booking">
                        ...
                        <li>
                            <a href="/bill/add" class="text-gray-500 hover:text-gray-700 p-2 rounded-md" title="Add Bill">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
